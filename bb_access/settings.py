...
AUTHENTICATION_BACKENDS = [
    ...
    "bb_access.auth.backends.UserOTPBackend",
]
...
sentry_sdk.init(
    environment=(
        "development" if DEBUG else os.getenv("SENTRY_ENVIRONMENT", "production")
    ),
...
SENDER_EMAIL_INTEGRATION_SMTP_HOST = os.getenv(
    "SENDER_EMAIL_INTEGRATION_SMTP_HOST", None
)
SENDER_EMAIL_INTEGRATION_SMTP_PORT = int(
    os.getenv("SENDER_EMAIL_INTEGRATION_SMTP_PORT", 25)
)
SENDER_EMAIL_INTEGRATION_SMTP_USE_SSL = bool(
    os.getenv("SENDER_EMAIL_INTEGRATION_SMTP_USE_SSL", False)
)
SENDER_EMAIL_INTEGRATION_SMTP_USE_STARTTLS = bool(
    os.getenv("SENDER_EMAIL_INTEGRATION_SMTP_USE_STARTTLS", False)
)
SENDER_EMAIL_INTEGRATION_SMTP_USER = os.getenv(
    "SENDER_EMAIL_INTEGRATION_SMTP_USER", None
)
SENDER_EMAIL_INTEGRATION_SMTP_PASSWORD = os.getenv(
    "SENDER_EMAIL_INTEGRATION_SMTP_PASSWORD", None
)
SENDER_EMAIL_INTEGRATION_SMTP_TIMEOUT = os.getenv(
    "SENDER_EMAIL_INTEGRATION_SMTP_TIMEOUT", 10
)
SENDER_EMAIL_INTEGRATION_SMTP_SENDER_NAME = os.getenv(
    "SENDER_EMAIL_INTEGRATION_SMTP_SENDER_NAME", None
)
SENDER_EMAIL_INTEGRATION_SMTP_SENDER_EMAIL = os.getenv(
    "SENDER_EMAIL_INTEGRATION_SMTP_SENDER_EMAIL", None
)

SENDER_SMS_INTEGRATION = os.getenv("SENDER_SMS_INTEGRATION", None)
SENDER_SMS_INTEGRATION_MAILJET_SENDER_NAME = os.getenv(
    "SENDER_SMS_INTEGRATION_MAILJET_SENDER_NAME", None
)
SENDER_SMS_INTEGRATION_MAILJET_TOKEN = os.getenv(
    "SENDER_SMS_INTEGRATION_MAILJET_TOKEN", None
)
...
# Libraries
DJPYKAFKA_EXIT_ON_EXCEPTION = os.getenv("DJPYKAFKA_EXIT_ON_EXCEPTION", True)
DJPYKAFKA_EXCEPTION_EXIT_RETRIES = int(
    os.getenv("DJPYKAFKA_EXCEPTION_EXIT_RETRIES", 10)
)
