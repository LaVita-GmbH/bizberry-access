...
def get_self(resp: Response, access: Access = Security(access_user, scopes=['access.users.read.own',])):
    """
...
def patch_user(
    ...
    transfer_to_orm(body, user, exclude_unset=True, access=access, action=TransferAction.NO_SUBOBJECTS)
