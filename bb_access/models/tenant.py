...
class TenantCountry(ModelAtomicSave):
    ...
    tenant: Tenant = models.ForeignKey(Tenant, on_delete=models.CASCADE, related_name='countries')
    code: str = models.CharField(max_length=2, help_text="ISO 3166 Alpha-2 Country Code")
